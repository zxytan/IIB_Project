...
def RenderModel(model, text_height=5, deformed_shape=False, deformed_scale=30,
                render_loads=True, color_map=None, combo_name='Combo 1', case=None, output_file=False,
                filename="pynite_model.vtu"):
    '''
    ...
    print(plate_polydata)
    
    if output_file == True:
        writer = vtk.vtkXMLPolyDataWriter()
        writer.SetFileName(filename)
        writer.SetInputData(plate_polydata)
        writer.Update()
        writer.Write()
